...
def notifier_callback(event_type, payload):
    ...
    try:
        ...
        graph_element = event_info['graph_element']  # e.g. N for Node, R for relationship, NR for both.
            ...
            try:
                ...
                if "R" in graph_element:
                    for relatiionship in event_info["relationships"]:
                        ...
                        source_node_properties[relatiionship["target_property_name_in_db"]] = payload[component_id_property_in_payload]

                        target_node_properties = {}
                        target_node_properties[relatiionship["target_node_property_in_db"]] = payload[relatiionship["target_node_type_id_in_payload"]]
